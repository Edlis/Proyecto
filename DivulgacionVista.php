...
<head>
    ...
    <title>Divulgacion Modificar</title>
    ...
    <link rel='stylesheet' id='blog-elegant-css'  href='blog/elegant/css/style.css' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='custom-button-mfast-3-css'  href='blog/small/css/style.css' type='text/css' media='all' />
...
<div id="page-meta" class="container">
    ...
    <div class="breadcrumbs">
        <p id="yit-breadcrumb" itemprop="breadcrumb">
            ...
            <a class="no-link current" href="#">Divulgacion Edicion</a>
        </p>
    </div>
</div>
<!-- END PAGE META -->
...
<div id="primary" class="sidebar-right">
    <div class="container group">
        <div class="row">
            ...
            <!-- Empieza Registro de Noticias -->
            <div id="content-blog" class="span9 content group">
                
            
                <?php
                require("DivulgacionVistaPHP.php");
                if(isset($_POST['Modificar'])){
                
                $idDivulgacion = $_POST['txtIdentificador']; 
                echo "Tu edad: $idDivulgacion<p>";
                ModificarDivulgacion($idDivulgacion);
